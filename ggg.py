...
#Now group by "Date" and calculate the average price
...
with st.container():
    selected_year = st.radio("Select Year", sorted(dataset['Date'].unique()))
    st.write("")  # Adding a space to separate the radio button from the plot
